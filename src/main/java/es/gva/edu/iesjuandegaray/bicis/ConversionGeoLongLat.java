...
// Para realizar la conversión vamos a añadir la clase ConversionGeoLongLat.java a nuestro proyecto, cuyo código es:
...
public class ConversionGeoLongLat {    
	public static String conversion(double xGeom, double yGeom){      
		...
		CoordinateReferenceSystem utm = crsFactory.createFromParameters("ETRS89_UTM30","+proj=utm +zone=30 +datum=WGS84 +units=m +no_defs");      
